...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    <center style="width: 100%; background-color: #f1f1f1;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; min-height:600px;">
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #F7FAFA; min-height:350px;">
            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="">
                <tr>
                <td align="center" valign="top" style="padding:10px;">
